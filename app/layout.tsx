...
export const metadata: Metadata = {
  ...
  description: 'China cleanroom manufacturer for mass-produced sandwich panels, modular cleanrooms, HVAC engineering, installation and validation for industrial facilities.',
  keywords: [
    ...
    'cleanroom panel manufacturer China',
...
const organizationSchema = {
  ...
  foundingDate: '1999',
  description: 'China manufacturer of cleanroom sandwich panels, supporting purification materials, modular cleanrooms, cleanroom equipment and HVAC systems. Integrated production lines support standardized mass production, bulk engineering orders, repeat supply and OEM/ODM requirements.',
  knowsAbout: [
    ...
    'Cleanroom sandwich panel manufacturing',
    'Cleanroom panel mass production',
    'Rock wool cleanroom panels',
    'Aluminum honeycomb cleanroom panels',
    'Paper honeycomb cleanroom panels',
    'Magnesium composite cleanroom panels',
    'OEM and ODM cleanroom panel production',
  ],
  areaServed: 'Worldwide',
  hasOfferCatalog: {
    '@type': 'OfferCatalog',
    name: 'Cleanroom manufacturing and engineering',
    url: 'https://rvcleans.com/manufacturing/',
    itemListElement: [
      'Rock wool fire-resistant cleanroom panels',
      'Aluminum honeycomb cleanroom panels',
      'Paper honeycomb cleanroom panels',
      'Magnesium composite cleanroom panels',
      'Color steel sandwich panels',
      'Supporting cleanroom purification materials',
